import{_ as n,V as s,W as a,Z as e}from"./framework-e5211252.js";const i={},l=e(`<h1 id="基本命令-chown-vim-cat" tabindex="-1"><a class="header-anchor" href="#基本命令-chown-vim-cat" aria-hidden="true">#</a> 基本命令 | chown/vim/cat</h1><h2 id="chown" tabindex="-1"><a class="header-anchor" href="#chown" aria-hidden="true">#</a> chown</h2><p>命令：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>chown（更改用户及用户组，全拼：change owner）
