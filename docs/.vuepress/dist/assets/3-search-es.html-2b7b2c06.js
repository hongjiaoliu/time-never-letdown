import{_ as o,V as p,W as l,X as n,Y as s,Z as e,$ as t,F as i}from"./framework-2197e39d.js";const c={},r=n("h1",{id:"_3-检索进阶",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_3-检索进阶","aria-hidden":"true"},"#"),s(" 3-检索进阶")],-1),u={id:"本节参考-官方文档-检索示例",tabindex:"-1"},d=n("a",{class:"header-anchor",href:"#本节参考-官方文档-检索示例","aria-hidden":"true"},"#",-1),v={href:"https://www.elastic.co/guide/en/elasticsearch/reference/current/getting-started-search.html",target:"_blank",rel:"noopener noreferrer"},k=t(`<h1 id="导入样本测试数据" tabindex="-1"><a class="header-anchor" href="#导入样本测试数据" aria-hidden="true">#</a> 导入样本测试数据</h1><p>准备一份顾客银行账户信息的虚构的JSON文档样本。每个文档都有下列的 schema（模式）。</p><div class="language-plsql line-numbers-mode" data-ext="plsql"><pre class="language-plsql"><code>{
