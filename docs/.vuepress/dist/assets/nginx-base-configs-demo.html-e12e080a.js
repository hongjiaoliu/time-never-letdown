import{_ as l,V as t,W as c,X as n,Y as s,$ as e,Z as i,F as p}from"./framework-e5211252.js";const o={},r=i(`<h1 id="nginx-2-核心配置" tabindex="-1"><a class="header-anchor" href="#nginx-2-核心配置" aria-hidden="true">#</a> Nginx | 2-核心配置</h1><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#定义 nginx 运行的用户和用户组</span>
