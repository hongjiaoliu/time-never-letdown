import{_ as n,V as s,W as a,Z as e}from"./framework-e5211252.js";const i={},p=e(`<h1 id="如何识别python版本与pip版本" tabindex="-1"><a class="header-anchor" href="#如何识别python版本与pip版本" aria-hidden="true">#</a> 如何识别python版本与pip版本</h1><h2 id="查询python版本" tabindex="-1"><a class="header-anchor" href="#查询python版本" aria-hidden="true">#</a> 查询python版本</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code> python <span class="token parameter variable">-V</span>
